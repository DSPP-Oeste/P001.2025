...
%\begin{tabular}{p{3cm}p{13.5cm}p{2cm}}
%\textbf{DGS} & Direção-Geral da Saúde & 1,3 \\
%\textbf{ULSO} & Unidade Local de Saúde do Oeste & 1 \\
%\textbf{XXXXXXX} & kfsdkfsdhf skdjfhskjdfhksdhfsd fsdf & 2 \\
%\textbf{XXXXXXX} & kfsdkfsdhf skdjfhskjdfhksdhfsd fsdf & 2  \\
%\textbf{XXXXXXX} & kfsdkfsdhf skdjfhskjdfhksdhfsd fsdf & 2  \\
%\textbf{XXXXXXX} & kfsdkfsdhf skdjfhskjdfhksdhfsd fsdf & 2  \\
%\end{tabular}
